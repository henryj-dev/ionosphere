...
const GATES: Record<string, Phase> = {
  ...
  P11: {
    ...
    outputs: [
      ...
      "apps/server/src/directory-source.ts",
      "apps/server/src/directory-config.ts",
      ...
      "packages/admin-cmd/src/shared-mailbox.ts",
      "packages/admin-cmd/test/shared-mailbox.test.ts",
