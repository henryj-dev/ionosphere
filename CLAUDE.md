...
⚠ **`AGENTS.md`는 이 파일의 사본이다**(트레일러 이름만 다르다). 규약을 고치면 **둘 다** 고칠 것 —
한쪽만 고쳐서 갈라진 적이 있다(2026-08-10 AGENTS.md가 Phase 6 이전 내용으로 추가됐다).
...
- 트레일러: `Co-Authored-By: Claude Opus 5 (1M context) <noreply@anthropic.com>`
